...
public class SignupActivity extends AppCompatActivity {
    ...
    private boolean registerUser(){
        ...
        if ( !((TextView) findViewById(R.id.textViewIDError)).getText().toString().equals("") ) {
            Toast.makeText(this, "이메일 중복", Toast.LENGTH_SHORT);
            return false;
        }
        if ( !((TextView) findViewById(R.id.textViewNicknameError)).getText().toString().equals("") ) {
            Toast.makeText(this, "닉네임 중복", Toast.LENGTH_SHORT);
            return false;
        }
        /////////////////////////////////////////////
                        ...
                        if(task.isSuccessful()){
                            ...
                            if(firebaseAuth.getCurrentUser() != null) {
                                ...
                                try {
                                    ...
                                    Toast.makeText(getApplicationContext(), "User table 등록에러", Toast.LENGTH_SHORT);
                                    nowuser.delete();
                                }
                            }
                        } else {
                            ...
                            ((TextView) findViewById(R.id.SaveError)).setText("등록에러 : 이메일 형태와 비밀번호 6자리를 지키세요!");
                        }
                        progressDialog.dismiss();
                    }
                });
